...
const CreateRole = memo(() => {
  ...
  const onSubmit = (e) => {
    RoleService.createRole(initialValues)
      .then((res) => {
        console.log("response from role", res.data);
        const RolePID = res.data.RolePID;
        allEntity.forEach((item) => {
          item.RolePID = RolePID;
        });
        RoleService.createEntityRole(allEntity)
          .then((res) => {
            ...
            >
              ...
              <Stack style={{ width: "90%" }}>
                ...
                >
                  ...
                  <td style={{border:'1px solid #FFF',fontWeight:'bold'}}>Entity</td>
                  <td style={{border:'1px solid #FFF',fontWeight:'bold'}}>Create</td>
                  <td style={{border:'1px solid #FFF',fontWeight:'bold'}}>Read</td>
                  <td style={{border:'1px solid #FFF',fontWeight:'bold'}}>View</td>
                  <td style={{border:'1px solid #FFF',fontWeight:'bold'}}>Edit</td>
                  <td style={{border:'1px solid #FFF',fontWeight:'bold'}}>Delete</td>
                  </tr>
